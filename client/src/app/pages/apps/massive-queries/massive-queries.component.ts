...
@Component({
  selector: 'fury-massive-queries',
  templateUrl: './massive-queries.component.html',
  styleUrls: ['./massive-queries.component.scss']
})
export class MassiveQueriesComponent implements OnInit, AfterViewInit, OnDestroy {
