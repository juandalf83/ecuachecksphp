...
import { ToolbarSidenavMobileToggleComponent } from './toolbar/toolbar-sidenav-mobile-toggle/toolbar-sidenav-mobile-toggle.component';
...
@NgModule({
  ...
  declarations: [LayoutComponent, ToolbarSidenavMobileToggleComponent]
})
